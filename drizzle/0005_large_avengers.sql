...
CREATE TABLE `albums` (
	...
	`releaseDate` integer DEFAULT '"2024-09-19T12:46:31.167Z"',
...
CREATE TABLE `errors` (
	...
	`name` text NOT NULL,
	`digset` text,
	`createdAt` integer DEFAULT '"2024-09-19T12:46:31.169Z"'
);
--> statement-breakpoint
...
CREATE TABLE `reviewsAlbums` (
	...
	`comment` text,
	`createdAt` integer DEFAULT '"2024-09-19T12:46:31.164Z"',
...
CREATE TABLE `reviewsArtists` (
	...
	`rating` integer NOT NULL,
	`comment` text,
	`createdAt` integer DEFAULT '"2024-09-19T12:46:31.163Z"',
...
CREATE TABLE `userNotifications` (
	...
	`createdAt` integer DEFAULT '"2024-09-19T12:46:31.179Z"',
...
CREATE UNIQUE INDEX `errors_name_unique` ON `errors` (`name`);--> statement-breakpoint
