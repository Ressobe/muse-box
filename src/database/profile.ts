...
export async function sendInvitationFriend(senderId: string, reciverId: string) {
...
export async function acceptInvitationFriend(userWhoAccept: string, senderId: string) {
...
export async function rejectInvitationFriend(userWhoReject: string, senderId: string) {
    const invitation = await db.invitation.findFirst({
        where: {
            senderId: senderId,
...
export async function followProfile(followedProfileId: string, followerProfileId: string) {
...
export async function unfollowProfile(followedProfileId: string, followerProfileId: string) {
    await db.profile.update({
        where: {id: followedProfileId},
        data: {
            followers: {
